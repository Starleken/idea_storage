package com.protobin.historyservicestarter.service;
...
public class HistoryService {
    ...
    public void sendMessage(Object dto, String entryId, HistoryAction historyAction) {
        ProducerRecord<String, Object> record = new ProducerRecord<>(TOPIC_NAME, entryId, dto);
        RecordHeader header = new RecordHeader(HEADER_NAME, historyAction.toString().getBytes());
